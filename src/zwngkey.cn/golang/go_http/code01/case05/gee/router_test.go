/*
 * @Author: wzmiiiiii
 * @Date: 2022-11-29 13:23:58
 * @LastEditors: wzmiiiiii
 * @LastEditTime: 2022-11-29 14:05:23
 */
package gee
...
func TestParsePattern(t *testing.T) {
	...
	ok = ok && reflect.DeepEqual(parsePattern("/p/:name/c"), []string{"p", ":name", "c"})
...
func TestGetRoute(t *testing.T) {
	...
	fmt.Printf("matched path: %s, p arams['name']: %s\n", n.pattern, ps["name"])
